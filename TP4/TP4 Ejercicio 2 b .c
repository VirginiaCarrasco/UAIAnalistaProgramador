...
int main(int argc, char *argv[]) {
 ...
 int cantidadFacturasMayores10000=0;
 int cantidadFacturasEntre400y700=0;
...
while(nroFactura!=0){
	...
	scanf("%d",&importeFactura);
 	...
 	if(importeFactura>10000){
 		cantidadFacturasMayores10000++;
	 }
	
	if(importeFactura>400 && importeFactura<=700){
		cantidadFacturasEntre400y700++;
	}
...
printf("La cantidad de facturas que superan los $10000 es de %d. \n",cantidadFacturasMayores10000);
printf("La cantidad de facturas que superan los $400 y son menores o iguales a $700 es de %d. \n",cantidadFacturasEntre400y700);
